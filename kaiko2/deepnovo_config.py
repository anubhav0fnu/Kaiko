...
tf.compat.v1.app.flags.DEFINE_string("train_dir", # flag_name
                           "train", # default_value
                           "Training directory.") # docstring

tf.compat.v1.app.flags.DEFINE_integer("direction",
                            2,
                            "Set to 0/1/2 for Forward/Backward/Bi-directional.")

tf.compat.v1.app.flags.DEFINE_boolean("use_intensity",
                            True,
                            "Set to True to use intensity-model.")

tf.compat.v1.app.flags.DEFINE_boolean("shared",
                            False,
                            "Set to True to use shared weights.")

tf.compat.v1.app.flags.DEFINE_boolean("use_lstm",
                            True,
                            "Set to True to use lstm-model.")

tf.compat.v1.app.flags.DEFINE_boolean("knapsack_build",
                            False,
                            "Set to True to build knapsack matrix.")

tf.compat.v1.app.flags.DEFINE_boolean("train",
                            False,
                            "Set to True for training.")

tf.compat.v1.app.flags.DEFINE_boolean("test_true_feeding",
                            False,
                            "Set to True for testing.")

tf.compat.v1.app.flags.DEFINE_boolean("decode",
                            False,
...
tf.compat.v1.app.flags.DEFINE_string("knapsack_file",
                           "model/knapsack.npy",
                           "Knapsack input directory.")

tf.compat.v1.app.flags.DEFINE_boolean("multi_decode",
                            False,
                            "Set to True for decoding multiple files.")

tf.compat.v1.app.flags.DEFINE_boolean("topk",
                            False,
                            "Set to True for decoding multiple files with topk.")

tf.compat.v1.app.flags.DEFINE_string("decode_dir",
                           "decode_output",
...
should be a list.
"""
tf.compat.v1.app.flags.DEFINE_string("mgf_dir", # flag_name
                           "", # default_value
                           "Directory containing mgf files.") # docstring
tf.compat.v1.app.flags.DEFINE_boolean("multi_train",
                            False,
                            "Set to True for training multiple files.")
tf.compat.v1.app.flags.DEFINE_string("data_format",
                            "mgf",
                            "Data file format for training multiple files.")
tf.compat.v1.app.flags.DEFINE_integer("lastindex",
                            17,
                            "last index for training files")
tf.compat.v1.app.flags.DEFINE_boolean("sigopt",
                            False,
                            "Set to True for hyperparameter optimization.")
tf.compat.v1.app.flags.DEFINE_string("api_token", # flag_name
                           "", # default_value
                           "API Token for your sigopt account.") # docstring
tf.compat.v1.app.flags.DEFINE_integer("experiment_id", # flag_name
                           -1, # default_value
                           "Experiment ID for your sigopt experiment.") # docstring
tf.compat.v1.app.flags.DEFINE_integer("epoch_stop", # flag_name
                           30, # default_value
                           "max number of epochs for training") # docstring
tf.compat.v1.app.flags.DEFINE_integer("num_observations", # flag_name
                           100, # default_value
                           "Number of observations for your sigopt experiment.") # docstring
tf.compat.v1.app.flags.DEFINE_float("learning_rate", # flag_name
                           0.001, # default_value
                           "learning rate.") # docstring
tf.compat.v1.app.flags.DEFINE_boolean("float64bits", # flag_name
                           False, # default_value
...
tf.compat.v1.app.flags.DEFINE_boolean("beam_search",
                            False,
                            "Set to True for beam search.")

tf.compat.v1.app.flags.DEFINE_integer("beam_size",
                            5,
                            "Number of optimal paths to search during decoding.")

tf.compat.v1.app.flags.DEFINE_boolean("search_db",
                            False,
                            "Set to True to do a database search.")

tf.compat.v1.app.flags.DEFINE_boolean("search_denovo",
                            False,
                            "Set to True to do a denovo search.")

tf.compat.v1.app.flags.DEFINE_boolean("search_hybrid",
                            False,
                            "Set to True to do a hybrid, db+denovo, search.")

tf.compat.v1.app.flags.DEFINE_boolean("test",
                            False,
                            "Set to True to test the prediction accuracy.")

tf.compat.v1.app.flags.DEFINE_boolean("header_seq",
                            True,
                            "Set to False if peptide sequence is not provided.")

tf.compat.v1.app.flags.DEFINE_boolean("decoy",
                            False,
